...
nth-of-type、nth-last-of-type、nth-child、nth-last-child这四个选择符很实用，可以选取第n个元素、奇数偶数、以及按等差数列的形式选取。

这四个区别是一个选择第n个元素，一个是选取第n个`子`元素。


-  `:nth-child(3)`  第3个子元素
-   `nth-child(1)` 第一个，等价于:first-child 
